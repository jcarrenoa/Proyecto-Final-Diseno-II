...
SECRET_KEY = 'django-insecure-^@0v!7_#9gy!knv@o)ghi@vau-!i1(ql7!1&tq9)u3a4n(hgsz'
...
LOGIN_URL = 'login'  # Nombre de la vista del login
LOGIN_REDIRECT_URL = '/'  # URL a la que se redirige después de loguearse exitosamente
